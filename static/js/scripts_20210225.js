...
(function($) {
    ...
    $("#process-list tr").click(function () {
        ...
        console.log("scripts.js #process-list onClick 후 가져 온 path: ", path);
        console.log("scripts.js #process-list onClick 후 가져 온 params: ", params);
        console.log("scripts.js #process-list onClick 후 가져 온 method: ", method);
        console.log("scripts.js #process-list onClick 후 가져 온 processCode: ", processCode);
    ...
    $("#period").on("click", function (e) {
        ...
        // console.log("scripts.js #period onClick 후 가져 온 path: ", path);
        // console.log("scripts.js #period onClick 후 가져 온 params: ", params);
        // console.log("scripts.js #period onClick 후 가져 온 method: ", path);
        // alert("scripts.js #period onClick 후 가져 온 ...");
    ...
    if (processCodeCurrent != "all") {
        ...
        if (productsArrList.length > 0 && productsArrList.length < 25) {
            ...
            // document.getElementById("chartArea").style.height = 1500 + "px";
