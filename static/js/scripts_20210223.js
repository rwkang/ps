...
(function($) {
    ...
    if (productsArrList.length > 50) {
        ...
        let charAreaHeight = document.getElementById("myChart").height;
        console.log("scripts.js 높이: ", 900);
        console.log("scripts.js charAreaHeight: ", charAreaHeight)
    } else {
        document.getElementById("chartLegend").style.height = 300 + "px";
        document.getElementById("myChart").height = 110;
        console.log("scripts.js 높이: ", 300)
    }
