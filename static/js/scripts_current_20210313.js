    ...
    */
    ...
    if (productsArrList.length > 0) {
        if (languageNo === 1042) {
            ...
            let achievementProcessText = achievementProcess.toLocaleString('ko-KR');
        } else if (languageNo === 1033) {
            ...
            let achievementProcessText = achievementProcess.toLocaleString('en-US');
        } else {
            ...
            let achievementProcessText = achievementProcess.toLocaleString('zh-CN');
        }
