...
(function($) {
    ...
    $(document).ready(function () {
        ...
        // var $table = $('#dataTable');
        // console.log(".toolbar 클릭!$table: ", $table);

        // $("#dataTable").on("click", ".page-link", function () {
        ...
        //     var ppQty = $(this).find('.ppQty').html();
        //     if (ppQty === undefined) {
        //         ppQty = 0;
        //     } else {
        //         ppQty = parseInt(ppQty);
        //     }
        //     // console.log("ppQty: ", ppQty);
        //     // console.log("typeof ppQty: ", typeof ppQty);
        //     // ppQtyTotal += parseInt(ppQty.html());
        //     ppQtyTotal += parseInt(ppQty);
        //     // console.log("ppQtyTotal: ", ppQtyTotal);
        ...
        // if (languageNo === 1042) {
        //     document.getElementById("ppQtyTotal").innerHTML = ppQtyTotal.toLocaleString('ko-KR');
        // } else if (languageNo === 1033) {
        //     document.getElementById("ppQtyTotal").innerHTML = ppQtyTotal.toLocaleString('en-US');
        // } else {
        //     document.getElementById("ppQtyTotal").innerHTML = ppQtyTotal.toLocaleString('zh-CN');
        // }
    ...
    $("#process-list tr").click(function () {
        ...
        // alert("scripts.js #process-list onClick 후 가져 온 ...");

        // 2021.02.25 Added. 진행바...
        // move1();
        // move2();
        // progressPopup2();
    ...
    $("#fromDate").datepicker({
        dateFormat: 'yy-mm-dd',
        language: lang,
        // timepicker: true, // 시간 이용...
        // timeformat: "hh:ii AA",
        //minDate: 0, // 오늘 날짜 이전은 선택이 불가 하게 함...
    ...
    // 2021.02.24 Conclusion. 아래 내용은 차트 완성을 위한 여정... 모두 참고 자료임.
...
// // 2021.02.24 Added. process.공정 정보 얻기를 함수화... ===> 여긴 안 되네...
// // 2021.02.09 Added. [table.td.tr 행 수 또는 그 값 가져오기.
// function getProcess() {
//     let arrProcessCode = $("td#process-code");
//     let arrProcessName = $("td#process-name");
//     console.log("getProcess()시작 arrProcessCode.length: ", arrProcessCode.length);
//     console.log("getProcess()시작 arrProcessName: ", arrProcessName);
//     console.log("getProcess()시작 typeof arrProcessName: ", typeof arrProcessName);
//     let processCode;
//     // 2021.02.09 Added. 만약 2개 이상의 공정 자료가 있을 때는, 모든 공정의 자료를 가져오게 한다.
//     if (arrProcessCode.length === 0 || arrProcessCode.length > 1) {
//         processCode = "all";
...
//         });
//     }
//     console.log("getProcess()보낼 processCode typeof:", typeof processCode);
//     console.log("getProcess()보낼 processCode: ", processCode);
//     console.log("getProcess()보낼 processCode: ", processCode);
//
...
function dataTableReset() {
    ...
    */
    ...
    $dataRows.each(function () {
        ...
        if (ppQty === undefined) {
            ppQty = 0;
        } else if (typeof ppQty === 'string' || ppQty instanceof String){
            // console.log("String 전 ppQty: ", ppQty);
            ppQty = ppQty.replace(/[,\{\}\[\]\(\)\'\"\?\*]/gi,""); // 여기서 반드시 [,] 컴마를 빼 주고, 숫자로 변환해야 되네...  [빽슬러쉬+특수문자] 형태로 적어줘야 한다...
            ppQty = parseInt(ppQty);
            // ppQty = Number(ppQty);
    ...
    // document.getElementById("ppQtyTotal").innerHTML = String(ppQtyTotal);
    if (languageNo === 1042) {
        document.getElementById("ppQtyTotalCurrentPage").innerHTML = ppQtyTotal.toLocaleString('ko-KR');
        document.getElementById("ppQtyTotalProcess").innerHTML = goodnessTotal.toLocaleString('ko-KR');
    } else if (languageNo === 1033) {
        document.getElementById("ppQtyTotalCurrentPage").innerHTML = ppQtyTotal.toLocaleString('en-US');
        document.getElementById("ppQtyTotalProcess").innerHTML = goodnessTotal.toLocaleString('en-US');
    } else {
        document.getElementById("ppQtyTotalCurrentPage").innerHTML = ppQtyTotal.toLocaleString('zh-CN');
        document.getElementById("ppQtyTotalProcess").innerHTML = goodnessTotal.toLocaleString('zh-CN');
    }
    // document.getElementById("ppQtyTotal").HTML = ppQtyTotalString; // 이건 확실히 아니네...
